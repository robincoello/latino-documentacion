...
Aplicando esto a la programación en Latino existe el valor 0 "cero" para falso y cualquier otro número o simbolo o letra representa verdadero, incluso números negativos.
